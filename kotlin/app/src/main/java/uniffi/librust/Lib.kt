...
object DW {
    ...
    val lib: DiplomatWriteLib = Native.load("librust", libClass)
...
internal class DiplomatJVMRuntime {
    companion object {
        ...
        val lib: DiplomatJVMRuntimeLib = Native.load("librust", libClass, Collections.singletonMap(Library.OPTION_ALLOW_OBJECTS, true))
